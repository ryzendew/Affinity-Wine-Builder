...
# Patches, builds, and packages Wine 11.11
#
# This script assumes:
...
#   - Patches are in patches/wine-11.11/
#
# Usage:
#   ./Build-Wine-11.0.sh
#
...
# Use ElementalWarrior-wine-11.11 as the directory name for proper packaging
INSTALL_PREFIX="${INSTALL_PREFIX:-$SCRIPT_DIR/ElementalWarrior-wine-11.11}"
...
# Print header
echo -e "${CYAN}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${CYAN}${BOLD}Wine 11.11 Build Script${NC}"
echo -e "${CYAN}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
...
# The tarball should extract to ElementalWarrior-wine-11.11/ with bin, include, lib, share inside
if [ -d "$INSTALL_PREFIX" ]; then
  ...
  # This ensures extraction creates ElementalWarrior-wine-11.11/ with bin, include, lib, share inside
  if tar -cJf "$PACKAGE_NAME" "$(basename "$INSTALL_PREFIX")" 2>/dev/null; then
    ...
    echo -e "  ${GREEN}ElementalWarrior-wine-11.11/${NC}"
    echo -e "    ${GREEN}bin/${NC}"
